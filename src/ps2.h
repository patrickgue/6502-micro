...
static ps2_scancode scancodes[101] = {
  ...
  { "8", 0x3E, 0xF03E },           { "9", 0x46, 0xF046 },
  { "0", 0x45, 0xF045 },           { "A", 0x1C, 0xF01C },
  { "B", 0x32, 0xF032 },           { "C", 0x21, 0xF021 },
  { "D", 0x23, 0xF023 },           { "E", 0x24, 0xF024 },
  { "F", 0x2B, 0xF02B },           { "G", 0x34, 0xF034 },
  { "H", 0x33, 0xF033 },           { "I", 0x43, 0xF043 },
  { "J", 0x3B, 0xF03B },           { "K", 0x42, 0xF042 },
  { "L", 0x4B, 0xF04B },           { "M", 0x3A, 0xF03A },
  { "N", 0x31, 0xF031 },           { "O", 0x44, 0xF044 },
  { "P", 0x4D, 0xF04D },           { "Q", 0x15, 0xF015 },
  { "R", 0x2D, 0xF02D },           { "S", 0x1B, 0xF01B },
  { "T", 0x2C, 0xF02C },           { "U", 0x3C, 0xF03C },
  { "V", 0x2A, 0xF02A },           { "W", 0x1D, 0xF01D },
  { "X", 0x22, 0xF022 },           { "Y", 0x35, 0xF035 },
  { "Z", 0x1A, 0xF01A },           { "`", 0x0E, 0xF00E },
  { "-", 0x4E, 0xF04E },           { "=", 0x55, 0xF055 },
  { "Backspace", 0x66, 0xF066 },   { "Tab", 0x0D, 0xF00D },
  { "[", 0x54, 0xF054 },           { "]", 0x5B, 0xF05B },
  { "\\", 0x5D, 0xF05D },          { ";", 0x4C, 0xF04C },
  { "Enter", 0x5A, 0xF05A },       { "Shift (Left)", 0x12, 0xF012 },
  { ",", 0x41, 0xF041 },           { ".", 0x49, 0xF049 },
  { "/", 0x4A, 0xF04A },           { "Caps Lock", 0x58, 0xF058 },
  { "ESC", 0x76, 0xF076 },         { "F1", 0x05, 0xF005 },
  { "F2", 0x06, 0xF006 },          { "F3", 0x04, 0xF004 },
  { "F4", 0x0C, 0xF00C },          { "F5", 0x03, 0xF003 },
  { "F6", 0x0B, 0xF00B },          { "F7", 0x83, 0xF083 },
  { "F8", 0x0A, 0xF00A },          { "F9", 0x01, 0xF001 },
...
int
init_ps2_encodings(ps2_encoding**);
void
add_ps2_encoding(ps2_encoding**, int, char, ps2_scancode, ps2_modifier);
ps2_scancode
get_scan_code(char*);

size_t
encode_ps2(ps2_encoding*, int, char*, uint8_t**);
char
decode_ps2(ps2_encoding*, uint32_t*, size_t);
